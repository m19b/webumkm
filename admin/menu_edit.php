        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?php
                      $id=$_GET['id'];
                      $query = mysqli_query($kon, "select *from menu where id='$id' LIMIT 1");
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    ...
                                    required="required" type="text" value="<?=$ed['ikon']?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                                    ...
                                    required="required" type="text" value="<?=$ed['link']?>">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="email" name="urut" required="required"
                                    class="form-control col-md-7 col-xs-12" value="<?=$ed['urut']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="status_aktif" id="genderM" value="Y" required
                                        <?php if($ed['status_aktif']=="Y"){echo "checked";} ?> />
                                    Aktif
                                    <input type="radio" class="flat" name="status_aktif" id="genderF" value="T"
                                        <?php if($ed['status_aktif']=="T"){echo "checked";} ?> />
                                    Non Aktif
                    ...
                    <?php
                        ...
                        $query2 = $kon->prepare("UPDATE menu SET urut = ?,link = ?,ikon = ?,nama = ?,status_aktif = ?,uraian_nama = ? where id = ?");
                        $query2->bind_param("isssssi",$urut,$link,$ikon,$nama,$status_aktif,$uraian_nama,$id);
